...
@objc protocol PlaceHolderTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: PlaceHolderTextView, height: CGFloat)
}
    ...
    override open var text: String! {
        ...
        override open func layoutSubviews() {
            ...
            if height != heightConstraint!.constant {
                ...
                if let delegate = delegate as? PlaceHolderTextViewDelegate {
